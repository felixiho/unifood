...
class FixReportModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      modal: props.modal,
  ...
  render() {
    return (
      <div>  
        <a href="/" onClick={ e => this.handleClickReport(e)}>Resolve Report </a>
        <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          <ModalHeader toggle={this.toggle}>Settle Report</ModalHeader>
          <ModalBody>
